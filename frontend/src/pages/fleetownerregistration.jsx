...
export default function FleetOwnerForm() {
  ...
  function setTruckField(id: string, field: keyof Truck, value: any) {
    setTrucks((t) => t.map((tr) => (tr.id === id ? { ...tr, [field]: value } : tr)));
  }

  function handleTruckPhotos(id: string, files: FileList | null) {
    if (!files) return;
  ...
  function validate() {
    ...
    for (const tr of trucks) {
      if (!tr.regNumber.trim()) return "प्रत्येक ट्रक के लिए रजिस्ट्रेशन नंबर आवश्यक है / Registration number required for each truck.";
    }
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: 16 }}>
      <h2>Fleet Owner Registration / फ्लीट ओनर पंजीकरण</h2>
      <form onSubmit={handleSubmit}>
        <section>
          <h3>Personal & Contact Information / व्यक्तिगत और संपर्क जानकारी</h3>
          <div>
        ...
        <section>
          <h3>KYC Details / केवाईसी विवरण</h3>
          <div>
        ...
        <section>
          <h3>Vehicle / Fleet Details / वाहन / फ्लीट विवरण</h3>
          {trucks.map((tr, idx) => (
        ...
        <section>
          <h3>Document Uploads / दस्तावेज़ अपलोड</h3>
          <div>
        ...
        <section>
          <h3>Declaration & Consent / घोषणा और सहमति</h3>
