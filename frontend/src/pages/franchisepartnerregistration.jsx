...
const SectionBox = ({ children, title, isDark }) => (
  ...
  >
    ...
    >
      <Typography variant="h5" component="h2" sx={{ mb: 3, fontWeight: 600, color: TailwindColors.primary, fontSize: { xs: '1.2rem', sm: '1.5rem' } }}>
        {title}
      </Typography>
      {children}
    </Box>
  ...
  return (
    ...
    >
      <DialogTitle sx={{ m: 0, p: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <Typography variant="h5" sx={{ fontWeight: 'bold', color: TailwindColors.success, fontSize: { xs: '1.25rem', sm: '1.5rem' } }}>
      ...
      <DialogContent dividers sx={{ borderColor: isDark ? TailwindColors.border + '50' : TailwindColors.border }}>
        <Box textAlign="center" py={3}>
          <CheckCircleOutlineIcon sx={{ color: TailwindColors.success, fontSize: { xs: 60, sm: 80 }, mb: 2 }} />
...
export default function FranchisePartnerForm() {
  ...
  return (
    ...
    >
      <Navbar />
      <Container maxWidth="lg" sx={{ mt: { xs: 4, sm: 6 }, py: { xs: 2, sm: 8 } }}>
        <motion.div variants={containerVariants} initial="hidden" animate="visible" exit="hidden">
          <Paper elevation={10} sx={{ bgcolor: cardBg, p: { xs: 2, sm: 4 }, borderRadius: 3, border: `2px solid ${TailwindColors.primary}`, transition: 'background-color 0.5s', }}>
            ...
            <Typography variant="h3" component="h1" gutterBottom align="center" sx={{ fontWeight: 700, mb: 4, color: sectionTitleColor, pb: 1, borderBottom: `3px solid ${TailwindColors.primary}`, fontSize: { xs: '1.5rem', sm: '3rem' } }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <Box sx={{ mt: 5, display: 'flex', justifyContent: 'center' }}>
                <Button type="submit" disabled={submitting}
                  variant="contained"
                  sx={{
                    px: { xs: 2, sm: 6 }, py: 1.5, fontSize: { xs: '1rem', sm: '1.2rem' }, width: { xs: '100%', sm: 'auto' },
