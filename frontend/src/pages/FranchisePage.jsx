...
import {
  ...
  People,
  TrendingUp,
  CreditCard, // New icon for partner/investment
  Warehouse, // New icon for delivery center/warehouse
} from '@mui/icons-material';
import Navbar from '../components/solutions/Navbar';
import Footer from '../components/solutions/Footer';
// Assuming these asset paths are correct in your project structure
import truckBgImage from '../assets/fullTruckLoad.png'; 
import officeImage from '../assets/office.png'; 

// --- Consolidated Franchise Data ---
const ALL_FRANCHISE_TYPES = [
  {
    icon: <Store />,
    title: "1. Load & Courier Booking Partner (लोड और कूरियर बुकिंग पार्टनर)",
  ...
  {
    icon: <Warehouse />,
    title: "2. Parcel Delivery Center (पार्सल वितरण केंद्र)",
    ...
    eligibility: [
      "Minimum 500 Sqft. of floor space (500 वर्ग फुट जगह की आवश्यकता)",
      "Delivery Rider Staff (डिलीवरी स्टाफ की आवश्यकता)"
    ],
    buttonText: "Parcel Delivery Center के लिए आवेदन करें",
    color: '#2e7d32',
    image: null, // Use default visual
  },
  {
    icon: <CreditCard />,
    title: "3. Full Load & Logistics Franchise Partner (पूर्ण लॉजिस्टिक्स फ्रेंचाइजी पार्टनर)",
    ...
    benefits: [
      ...
      "Benefit from trusted platform & training (भरोसेमंद प्लेटफॉर्म और ट्रेनिंग का लाभ)"
    ],
    eligibility: [
  ...
  {
    icon: <LocalShipping />,
    title: "4. RILogistics Fleet Partner (फ्लीट पार्टनर)",
    ...
    benefits: [
      "Affordable setup cost (किफायती सेटअप लागत)",
      "Earn profit on every vehicle (हर वाहन पर लाभ कमाएं)",
      "Stable and growing income (स्थिर और बढ़ती आय)"
    ],
    eligibility: [
      "100–250 sq. ft. office space (100–250 वर्ग फुट ऑफिस जगह)",
      "Minimum 5 vehicles required (न्यूनतम 5 वाहन आवश्यक) - *Correction from 20*",
      "Basic understanding of fleet coordination (फ्लीट समन्वय की बुनियादी समझ)"
    ],
...
const FranchisePage = () => {
  ...
  const primaryRed = '#ef4444'; // Use the specific red color consistently
  ...
  // FAQ Data remains the same (renamed "Relogistics" to "RIlogistics" for consistency)
  const faqData = {
    exchangeCenter: [
      {
        question: "What is Local Delivery Franchise? (लोकल डिलीवरी फ्रेंचाइजी क्या है?)",
        answer: "The program is an extension of the RIlogistics pick-up and delivery network. We seek entrepreneurs willing to run their own parcel and freight pick-up and delivery business."
      },
      {
        question: "Who can become a Local Delivery Franchise partner? (पार्टनर कौन बन सकता है?)",
        answer: "Any entrepreneur with the required infrastructure and business acumen can apply to become a franchise partner."
      },
      // ... rest of the exchangeCenter FAQs
      {
        question: "How long does the application process take? (आवेदन प्रक्रिया में कितना समय लगता है?)",
        answer: "The application process typically takes 2-4 weeks from submission to approval."
      },
      {
        question: "Does it cost anything to become a partner for RIlogistics? (क्या यह निःशुल्क है?)",
        answer: "There is an initial setup cost that varies based on the franchise type you choose."
      },
      {
        question: "Will training be provided? (क्या प्रशिक्षण प्रदान किया जाएगा?)",
    ...
    courierStore: [
      ...
      {
        question: "What infrastructure is needed to set up a RIlogistics courier store?",
        answer: "You need a retail space of 60-80 sqft in a prime location with good footfall."
      },
      {
        question: "Is there an investment involved? (क्या इसमें कोई निवेश शामिल है?)",
        answer: "Yes, there is an initial investment for store setup, branding, and operational requirements."
      },
      {
        question: "How can I earn by joining RIlogistics courier franchise program? (मैं कैसे कमा सकता हूँ?)",
    ...
    <Box sx={{ bgcolor: 'background.default', minHeight: '100vh' }}>
      ...
      >
        <Container maxWidth="lg">
          <Box sx={{ maxWidth: '800px' }}>
            <Box sx={{ width: 60, height: 4, bgcolor: primaryRed, mb: 3 }} />
            <Typography
              variant="h2"
              sx={{
                fontWeight: 700,
            ...
            >
              Associate with <Box component="span" sx={{ color: primaryRed }}>India's fastest</Box>
              <br />
      ...
      <Container maxWidth="xl" sx={{ py: 8 }}>
        <Box sx={{ textAlign: 'center', mb: 6 }}>
          ...
          <Box sx={{ width: 80, height: 4, bgcolor: primaryRed, mx: 'auto' }} />
        </Box>
          ...
          {ALL_FRANCHISE_TYPES.map((franchise, index) => (
            <Grid item xs={12} md={6} lg={3} key={index} sx={{ display: 'flex' }}>
              <Paper
                ...
                sx={{
                  ...
                  '&:hover': {
                    ...
                    boxShadow: 8,
                    border: `2px solid ${franchise.color}`,
                  },
              ...
              >
                ...
                <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 2, borderBottom: `2px solid ${alpha(franchise.color, 0.2)}`, pb: 2 }}>
                  ...
                  <Box sx={{ flex: 1 }}>
                    <Typography variant="subtitle1" sx={{ fontWeight: 700, lineHeight: 1.3, color: franchise.color }}>
                      {franchise.title.split(' (')[0]}
                    </Typography>
                    <Typography variant="caption" color="text.secondary">
                        {franchise.title.split(' (')[1] ? `(${franchise.title.split(' (')[1]}` : ''}
                    </Typography>
                  </Box>
                </Box>
                ...
                {/* Button (Pushed to bottom using flex) */}
                <Button
                  variant="contained"
                  fullWidth
                  size="large"
        ...
        {/* OR Divider remains outside the grid */}
      ...
      <Box sx={{ bgcolor: alpha(theme.palette.primary.main, 0.05), py: 8 }}>
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', mb: 6 }}>
            <Typography variant="h3" sx={{ fontWeight: 700, mb: 2 }}>
              Frequently asked <Box component="span" sx={{ color: primaryRed }}>questions</Box> (अक्सर पूछे जाने वाले सवाल)
            </Typography>
            <Box sx={{ width: 80, height: 4, bgcolor: primaryRed, mx: 'auto' }} />
          </Box>
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        <Box sx={{ mb: 6, textAlign: 'center' }}>
          <Typography variant="h3" sx={{ fontWeight: 700, mb: 2 }}>
            Other ways you can <Box component="span" sx={{ color: primaryRed }}>Join RIlogistics</Box> (अन्य तरीके जिनसे आप जुड़ सकते हैं)
          </Typography>
          <Box sx={{ width: 80, height: 4, bgcolor: primaryRed, mx: 'auto' }} />
        </Box>
              ...
              >
                ...
                <CardContent sx={{ p: 3, display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                  ...
                  <Button
                    endIcon={<ArrowForward />}
                    variant="outlined"
                    sx={{ fontWeight: 600, alignSelf: 'flex-start', color: primaryRed, borderColor: primaryRed, '&:hover': {borderColor: primaryRed, bgcolor: alpha(primaryRed, 0.05)} }}
                  >
                    Learn More (और जानें)
                  </Button>
                </CardContent>
